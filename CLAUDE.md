...
Kontext für Claude Code in diesem Bitburner-Projekt.
...
- **Pair-Programming-Stil**: Claude macht Code-*Vorschläge*, wir besprechen
...
- Corp-Factions / Augmentation-Route: Details in `CODEX_NOTES.md`. Achtung: Teile
  ...
  im Zweifel diese CLAUDE.md priorisieren.
